        ...
        <main className="px-10 py-10">
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-6">
              <StatCard label="Total Bookings" value={totalBookings} icon={<BoxIcon />} tone="yellow" />
              <StatCard label="Pending Approval" value={pendingApproval} icon={<UsersIcon />} tone="purple" />
              <StatCard label="Pending Accounts" value={pendingAccounts} icon={<ClockIcon />} tone="orange" />
              <StatCard label="Total Facilities" value={totalFacilities} icon={<ChartIcon />} tone="green" />
            </div>
          )}
        </main>
      </div>
